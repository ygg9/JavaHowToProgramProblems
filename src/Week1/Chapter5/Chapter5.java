    ...
    public static void main(String[] args){
        ...
        while(flag != -1){
            ...
            switch(productNumber){
                case 1: totalRetail += product1 * quantity;
                    break;
                case 2: totalRetail += product2 * quantity;
                    break;
                case 3: totalRetail += product3 * quantity;
                    break;
                case 4: totalRetail += product4 * quantity;
                    break;
                case 5: totalRetail += product5 * quantity;
                    break;
                case -1:
                    break;
