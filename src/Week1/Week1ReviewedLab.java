...
public class Week1ReviewedLab {
    ...
    public static void printPerformers(int numberOfPerformers){
    ...
    public static void printDancers(int numberOfDancers){
    ...
    public static void printVocalists(int numOfVocalists){
